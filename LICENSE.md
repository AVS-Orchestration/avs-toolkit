...
**ShareAlike** — If you build a NEW framework or NEW template based on this one, you must share it under this same license.

## 2. THE DATA PRIVACY EXCEPTION (CRITICAL)
...
- Using these templates to store proprietary business logic, private goals, or sensitive context does **NOT** require you to "ShareAlike" that sensitive content.

- You may keep your populated Value Stories private and internal to your organization.
